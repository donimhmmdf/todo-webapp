            ...
            <div class="p-4">
              <form @submit.prevent="isEdit ? updateTodo() : addTodo()">
                ...
                <input
                  ...
                  class="block rounded-md my-3 dark:text-black"
                ...
                <input
                  ...
                  class="block w-full rounded-md my-3 dark:text-black"
                ...
                <input
                  ...
                  class="block w-full rounded-md my-3 dark:text-black"
                />
                <label for="datetime" class="font-semibold text-sm"
                  >Datetime</label
                >
                <input
                  type="date"
                  v-model="currentTodo.datetime"
                  class="block w-full rounded-md mt-3 dark:text-black"
                />
